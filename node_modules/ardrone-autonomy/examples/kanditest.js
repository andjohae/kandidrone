...
mission.client().config('general:navdata_magneto', true);
...
//mission.client().on('navdata', function(d) {
//  console.log(d.rotation.yaw)
//})

mission.client().on('batteryChange', function(d) {
  console.log(d);
});
