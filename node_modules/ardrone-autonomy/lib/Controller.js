...
EPS_LIN      = 0.25; // We are ok with 10 cm horizontal precision
EPS_ALT      = 0.25; // We are ok with 10 cm altitude precision
...
Controller.prototype._control = function(d) {
    ...
    var cx   = within(Math.cos(yaw) * ux + Math.sin(yaw) * uy, -maxmin, maxmin);
    var cy   = within(-Math.sin(yaw) * ux + Math.cos(yaw) * uy, -maxmin, maxmin);
    var cz   = within(uz, -maxmin, maxmin);
