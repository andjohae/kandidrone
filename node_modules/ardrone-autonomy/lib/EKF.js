...
EKF.prototype.reset = function() {
  if (this._state !== undefined) {
    this._startYaw  = this._state.yaw;
    console.log("startYaw set")
    console.log(this._startYaw)
  } else {
    this._startYaw  = 0;
    console.log("startYaw=0")
  }
...
EKF.prototype.predict = function(data) {
    var pitch = data.demo.rotation.pitch.toRad()
      ...
      //, dt    = this._delta_t
/*-------------------------------------------------------------
    Changes made by the kandiDrone team:
        -Now calculates a time difference rather than using a fixed time step.
*/
    var dtObj = this._getDt(this._lastTime);
    var dt = dtObj.dt;
    this._lastTime = dtObj.lastTime;
...
EKF.prototype._getDt = function(lastTime) {
    var hrTime = process.hrtime();
    var currTime = hrTime[0] + hrTime[1]/1000000;
    ...
    lastTime=currTime;
    return { dt: dt, lastTime: lastTime };
}
